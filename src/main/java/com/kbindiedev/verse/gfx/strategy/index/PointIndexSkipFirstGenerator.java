...
/** Generates indices for points, but skips the first point. */
public class PointIndexSkipFirstGenerator implements IIndexGenerator {

    public static final PointIndexSkipFirstGenerator INSTANCE = new PointIndexSkipFirstGenerator();

    private PointIndexGenerator core = PointIndexGenerator.INSTANCE;
